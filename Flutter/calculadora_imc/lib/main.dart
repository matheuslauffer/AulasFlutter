  ...
  void _calculate(){
    setState(() {
      ...
      if(imc < 18.6){
        ...
        _infoText = "Obeisdade grau 1 (${imc.toStringAsPrecision(2)})";
      }else if(imc >= 34.9 && imc < 39.9){
        _infoText = "Obeisdade grau 2 (${imc.toStringAsPrecision(2)})";
      }else if(imc >= 40){
        _infoText = "Obeisdade grau 3 (${imc.toStringAsPrecision(2)})";
      }
    });
  }
  @override
